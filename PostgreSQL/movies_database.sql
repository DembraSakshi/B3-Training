...
--Inser data into movie script table
...
--insert data into movie revenue script
...
--insert data into movie actors script
...
--Select the first and last names of all American directios

SELECT first_name , last_name FROM directors
WHERE nationality = 'American';


--Select all mail actor born after the 1st of jan 1978
SELECT * FROM actors ;
WHERE gender = 'M'
AND date_of_birth >'1970-01-01';


--Select the name of all movies which are over 90 min long language english
SELECT movie_name FROM movies
WHERE movie_length >90
AND movie_lang = 'English';


--Section 5 Cahllenge 2

--Select the movie names and movie language of all movies with a movie language of English, 
--Spanish or Korean. 
...
--Use a left join to select the first and last names of all British directors and 
